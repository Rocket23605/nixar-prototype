                      ...
                      {!isCorrect && (
                        <div className="mt-3 p-3 rounded-lg bg-secondary/50">
                          <p className="text-sm text-muted-foreground">
                            ...
                            {q.category === "แคลคูลัส" && q.id === 1 &&
                              "ใช้สูตร d/dx(xⁿ) = nxⁿ⁻¹ ดังนั้น d/dx(3x³) = 9x², d/dx(2x²) = 4x, d/dx(-5x) = -5, d/dx(1) = 0"}
                            {q.category === "แคลคูลัส" && q.id === 2 &&
                              "ใช้สูตร ∫xⁿdx = xⁿ⁺¹/(n+1) + C ดังนั้น ∫2xdx = x² และ ∫3dx = 3x รวมกันได้ x² + 3x + C"}
                            {q.category === "พีชคณิต" &&
                              "แยกตัวประกอบ x² - 5x + 6 = (x-2)(x-3) = 0 ดังนั้น x = 2 หรือ x = 3"}
                            {q.category === "ตรีโกณมิติ" &&
                              "ตามอัตลักษณ์ตรีโกณมิติพื้นฐาน sin²θ + cos²θ = 1 เสมอ ไม่ว่ามุม θ จะเป็นเท่าใด"}
                            {q.category === "สถิติ" &&
                              "ค่าเฉลี่ยเลขคณิต = ผลรวม/จำนวนข้อมูล = (2+4+6+8+10)/5 = 30/5 = 6"}
                          </p>
                        </div>
                      )}
                    </div>
